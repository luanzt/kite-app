      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <Icons.Today size={24} color={color} strokeWidth={focused ? 2.4 : 2} />
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <Icons.Trackers size={24} color={color} strokeWidth={focused ? 2.4 : 2} />
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <Icons.Settings size={24} color={color} strokeWidth={focused ? 2.4 : 2} />
          ),
        }}
      />
    </Tab.Navigator>
